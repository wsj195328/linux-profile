...
URLKernel='https://raw.githubusercontent.com/wsj195328/linux-profile/master/speeder/serverSpeeder.txt'
...
wget --no-check-certificate -q -O "/tmp/appex/apxfiles/bin/acce-"$KNV"-["$KNA"_"$KNN"_"$KNK"]" "https://github.com/wsj195328/serverSpeeder_kernel/master/$MyKernel"
...
wget --no-check-certificate -q -O "/appex/etc/apx.lic" "http://rs.91yun.pw/apx1.php?mac=$MAC"
...
{
[ ! -f /tmp/appex.zip ] && wget --no-check-certificate -q -O "/tmp/appex.zip" "https://raw.githubusercontent.com/wsj195328/linux-profile/master/speeder/appex.zip"
